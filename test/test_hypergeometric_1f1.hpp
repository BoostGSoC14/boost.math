...
void test_hypergeometric(T, const char* name)
{
  ...
  static const boost::array<boost::array<T, 4>, 35> pearson_1f1_data = {{
    ...
    {{ SC_(20), -boost::math::constants::pi<T>() * 3, SC_(-2.5), SC_(-459.7875667063203123347166727428484134851591729699138974283514) }},
    {{ SC_(20), boost::math::constants::pi<T>() * 3, SC_(2.5), SC_(122.18665421816610412294237478730436434907793724942950) }},
    {{ SC_(-20), -boost::math::constants::pi<T>() * 3, SC_(2.5), SC_(269.066377517348825230568727303741204558261168571043416124554) }},
    {{ SC_(50), SC_(10), SC_(200), SC_(1.70970417612603891522605058021030241438424161666807852280059e125) }},
    {{ SC_(-5), -boost::math::constants::pi<T>() * 2, SC_(-1), SC_(0.444913437706720747615165269249706557611011297777085582480832) }},
